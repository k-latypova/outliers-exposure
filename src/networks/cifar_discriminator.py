...
#
#         self.block_1 = get_initial_disc_block(3, 64, kernel_size=4, stride=2, padding=1)
#         self.block_2 = get_disc_block(64, 128, kernel_size=4, stride=2, padding=1)
#         self.block_3 = get_disc_block(128, 256, kernel_size=4, stride=2, padding=1)
#         self.block_4 = get_disc_block(256, 512, kernel_size=4, stride=2, padding=1)
#         self.block_5 = get_disc_block(512, 1024, kernel_size=4, stride=2, padding=1)
#
#         self.block_6 = get_final_disc_block(1024, 1, kernel_size=4, stride=1)
#
#        # self.block_5 = get_final_disc_block(256, 1, kernel_size=4, stride=1)
#
#
